...
class StaticServer {
  constructor(options={}) {
    ...
    this.enableCacheControl = options.cacheControl;
    this.enableExpires = options.expires;
    this.enableETag = options.etag;
    this.enableLastModified = options.lastModified;
